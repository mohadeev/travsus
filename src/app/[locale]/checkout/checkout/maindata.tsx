...
// import RowBedAccommodationSelector from '../../[continent]/[country]/[region]/[city]/[things-to-do]/[category]/[name]/[id]/(service-detail)/[listing-experiences-detail]/RowBedAccommodationSelector/RowBedAccommodationSelector'
import GuestsInput from '../../[continent]/[country]/[region]/[city]/[things-to-do]/[category]/[name]/[id]/(service-detail)/[listing-experiences-detail]/RowBedAccommodationSelector/GuestsInput'
import AcommodationAndTransport from '../../[continent]/[country]/[region]/[city]/[things-to-do]/[category]/[name]/[id]/(service-detail)/[listing-experiences-detail]/RowBedAccommodationSelector/listing-components/AcommodationAndTransport'
import LineItemsBreakdown from '../../[continent]/[country]/[region]/[city]/[things-to-do]/[category]/[name]/[id]/(service-detail)/[listing-experiences-detail]/RowBedAccommodationSelector/LineItemsBreakdown'
import RowBedAccommodationSelector from '../../[continent]/[country]/[region]/[city]/[things-to-do]/[category]/[name]/[id]/(service-detail)/[listing-experiences-detail]/RowBedAccommodationSelector'
	...
	const handleAccomodationChange = async (data: any) => {
		...
		await dispatch(
			updateLineItemsAsync({
				...
				booking: { ...booking, ...{ accommodation: newAccommodation } },
			}),
		)
	}
	const renderSidebar = () => {
			...
			<div className="flex w-full flex-col space-y-6 border-neutral-200 px-0 dark:border-neutral-700 sm:space-y-8 sm:rounded-2xl sm:p-6 lg:border xl:p-8">
				...
				<div className="flex flex-col space-y-4">
					...
					{/* <div className="text-neutral-6000 flex justify-between dark:text-neutral-300">
						<span>
							${booking.pricePerSeat} x {booking.seats} guests
						</span>
