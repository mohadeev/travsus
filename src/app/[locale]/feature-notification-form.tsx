...
const messageMap = {
	EMAIL_REQUIRED: '📭 Please enter your email address so we can notify you.',
	INVALID_EMAIL:
...
export default function FeatureComingSoonModal({
	...
	featureDescription = "We're working hard to bring you this exciting new feature. Leave your email and we'll notify you as soon as it's ready.",
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			// Use the dedicated feature notification API endpoint
			const response = await fetch('/api/user/post/feature-notification', {
				method: 'POST',
				headers: {
