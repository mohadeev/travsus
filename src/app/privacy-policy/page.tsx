...
export const metadata: Metadata = {
	title: 'Privacy Policy | TRAVSUS',
	description: 'Data Protection and Privacy Policy for TRAVSUS travel services',
}
...
Below, we outline the conditions under which TRAVSUS processes your personal data in a question-and-answer format:
...
The data processed to process the purchase of a TRAVSUS gift card, as well as its delivery, if applicable, will be kept for this purpose for as long as the contract/service is valid. Once this relationship has ended, if applicable, the data may be kept for the time required by the applicable legislation and until any liabilities arising from the contract expire.
...
The data provided through social media will be kept for as long as you remain a friend and/or follower of TRAVSUS on the corresponding platform or social network.
...
The processing of personal data to respond to users who contact TRAVSUS by any means regarding their requests for information, requests, queries and complaints is based on the consent of the person concerned, unless said complaint, query, request or request for information is made by a client by virtue of the services contracted, in which case the legitimate basis will be that reflected in the general conditions applicable to them.

The prospective offer of TRAVSUS products and services to users is based on consent, except in the case of affiliates, accommodation, providers and agencies, which is based on legitimate interest, as indicated in the general conditions applicable to each of them.
...
The data processed in order to process the purchase of a TRAVSUS gift card, as well as its delivery, will be processed on the basis of the execution of the contract resulting from the purchase of such card.
...
The data of the people who have acquired a TRAVSUS gift card will be communicated to the recipient of the same, if applicable, so that they may know who has given them the gift.
...
Although this is not a transfer of data, it may be that third party companies, acting as providers to TRAVSUS, access your information to carry out the service. These providers access your data following our instructions and without being able to use them for a different purpose and maintaining the strictest confidentiality on the basis of a contract in which they undertake to comply with the requirements of the current regulations on personal data protection.
...
TRAVSUS contracts its virtual infrastructure for the storage of its database according to a "cloud computing" model through Amazon Web Services (AWS), with the information being stored in the European Union, in compliance with GDPR requirements.

TRAVSUS uses the Sendgrid platform to send transactional communications related to the services provided, as well as for communications to Accommodations, Affiliates, Agencies and Providers. The use of this platform, owned by Twilio, involves international data transfers to the USA. However, this entity offers adequate data protection guarantees as it has signed the Standard Contractual Clauses approved by the European Commission (SCC). You can find more information here, as well as a copy of the content of the SCC in Annex 3 of its Data Protection Addendum.

## 9. Is the location of users who download the TRAVSUS mobile application known?

When you download the TRAVSUS mobile app, you'll be asked for permission to access your location in order to show you activities near you. This processing is based on your consent, which you can revoke at any time by disabling location access in the TRAVSUS app. Location processing is not necessary for using the app, but without it, we won't be able to show you nearby activities.
...
- [Right of access form](https://www.travsus.com/rights/access)
- [Right to rectification form](https://www.travsus.com/rights/rectification)
- [Right to object form](https://www.travsus.com/rights/object)
- [Right to erasure ("right to be forgotten") form](https://www.travsus.com/rights/erasure)
- [Right to restriction of processing form](https://www.travsus.com/rights/restriction)
- [Right to data portability form](https://www.travsus.com/rights/portability)
- [Right not to be subject to a decision based solely on automated processing form](https://www.travsus.com/rights/automated-decision)

All the aforementioned rights can be exercised through the means of contact listed at the beginning.

In the event of any violation of your rights, especially when you have not obtained satisfaction in the exercising of your rights, you can file a complaint with the Data Protection Commission (contact details available at www.dataprotection.ie), or other competent supervisory authority. You can also obtain more information about your rights by contacting these bodies.
...
However, absolute security cannot be guaranteed, and no security system is impenetrable. Therefore, in the event that any information under our control is compromised as a result of a security breach, we will take appropriate measures to investigate the incident, notify the Data Protection Commission, and, if applicable, inform those users who may have been affected so they can take appropriate action.

## 12. What is your responsibility as the data subject?

By providing us with your personal data, you guarantee that you are over 16 years of age and that the data provided is true, accurate, complete and up-to-date.
...
With respect to the purchase of a TRAVSUS gift card, the data of the recipient of the same, if applicable, are provided by the purchaser when filling out the corresponding form, providing the contact data indicated therein: name and e-mail address. The buyer is responsible for having the authorization of the recipient prior to providing their data to TRAVSUS.

Finally, sometimes, the data of the final customers may be provided by the agency that proceeds to the contracting of the experience offered by TRAVSUS on their behalf, so that the contracted services can be offered, as indicated in the General Conditions of Use.

## 14. Changes to this Privacy Policy

We may update this Privacy Policy from time to time. The most current version will always be available on our website. We encourage you to review this Privacy Policy periodically to stay informed about how we are protecting your information.
	...
	return (
		<div className="mx-auto max-w-4xl px-4 py-8">
			...
			<div className="prose prose-sm max-w-none">
				<MDXRemote source={privacyPolicyContent} components={components} />
			</div>
		</div>
	)
}
