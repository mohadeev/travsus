...
const LanguagePreferencesModal: FC<Props> = ({
	...
	const languages = [
		...
		{ name: 'English (Hong Kong)', code: 'en_HK' },
		...
		{ name: 'Indonesian (Indonesia)', code: 'id_ID' },
		...
		{ name: 'Norwegian Bokmål (Norway)', code: 'nb_NO' },
		...
		{ name: 'Serbian Latin (Serbia)', code: 'sr_Latn_RS' },
		...
		{ name: 'Chinese (Simplified, China)', code: 'zh_CN' },
		{ name: 'Chinese (Traditional, Hong Kong)', code: 'zh_Hant_HK' },
		{ name: 'Chinese (Traditional, Taiwan)', code: 'zh_TW' },
