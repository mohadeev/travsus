...
export default function AnalyticsPage() {
  return (
    <DashboardShell>
      <DashboardHeader heading="Analytics" text="Track and visualize your business performance">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Bookings Conversion</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <TabsContent value="sales">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Tour sales by category and location</CardDescription>
            </CardHeader>
            <CardContent>
              <SalesAnalytics />
            </CardContent>
