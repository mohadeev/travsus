...
export const metadata: Metadata = {
	...
	alternates: {
		canonical:
			'https://morocco-desert-tours.com/3-day-desert-tour-marrakech-to-merzouga',
		languages: {
...
export default function DesertTourPage() {
	return (
		<LanguageProvider>
			<main className="fixed left-0 right-0 top-0 z-50 flex h-full min-h-screen w-full flex-col overflow-auto bg-white">
				<TourHeader />
				<HeroSection />
				<TourOverview />
				<TourHighlights />
